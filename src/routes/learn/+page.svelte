<script>
	...
	//UI
	import { Card, SpeedDial, SpeedDialButton } from 'flowbite-svelte';
					...
					try {
						...
						if (textChunk) {
							...
							if (data.error_code === 0) {
								...
								output = data.text + ` (error_code: ${data.error_code})`;
								messages[index].text = output;
							}
						}
...
<div
	class="{darkMode
		? 'bg-[#222222] text-light'
		: 'bg-light text-black'} flex justify-center items-center"
>
	<div class="flex flex-col w-full h-[90vh]">
		<!--Chat Section-->
		{#if model}
			<!--Chats-->
			<div class="flex flex-col overflow-y-auto h-full gap-4 pt-4">
					...
					<Card
						...
						on:click={() => {
							...
							messages = [
								{
									isUser: false,
									text: "Hi there! I'm an AI specialized in human anatomy. I can provide you with accurate information on body structure and function, as well as suggest relevant sources for non-anatomy questions. If you have any questions related to the human body or anatomy, feel free to ask."
								}
							];
						}}
					>
						...
						<h5 class="mb-2 tracking-tight text-gray-900 dark:text-white font-medium">Anatomy</h5>
					</Card>
					<Card
						...
						on:click={() => {
							...
							messages = [
								{
									isUser: false,
									text: "Hi there! I'm an AI specialized in microbiology. I can help you with any questions or topics related to microbiology. If you have a non-microbiology question, I'll direct you to a relevant source to find the information you need."
								}
							];
						}}
					>
					...
					<Card
						...
						on:click={() => {
							...
							messages = [
								{
									isUser: false,
									text: "Hi there! I'm an AI specialized in pharmacology. I can help you with various aspects of drugs, such as their interactions, mechanisms, uses, side effects, and pharmacokinetics. If you have any questions related to pharmacology, feel free to ask."
								}
							];
						}}
					>
					...
					<Card
						...
						on:click={() => {
							...
							messages = [
								{
									isUser: false,
									text: "Hi there! I'm an AI specialized in BioChemistry. If you have any questions related to the BioChemistry, feel free to ask."
								}
							];
						}}
					>
					...
					<Card
						...
						on:click={() => {
							...
							messages = [
								{
									isUser: false,
									text: "Hi there! I'm an AI specialized in human Physiology. If you have any questions related to the Physiology, feel free to ask."
								}
							];
						}}
					>
					...
					<Card
						...
						on:click={() => {
							...
							messages = [
								{
									isUser: false,
									text: "Hi there! I'm an AI specialized in Pathology. If you have any questions related to the Pathology, feel free to ask."
								}
							];
						}}
					>
						...
						<h5 class="mb-2 tracking-tight text-gray-900 dark:text-white font-medium">Pathology</h5>
					</Card>
				</div>

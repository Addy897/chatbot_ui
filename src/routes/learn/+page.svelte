			...
			{/if}
					<div class="grid  gap-2 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 ">
						<Card
							...
							on:click={() => {
								model = 'Anatomy';
                                messages=[{isUser:false,text:"Hi there! I'm an AI specialized in human anatomy. I can provide you with accurate information on body structure and function, as well as suggest relevant sources for non-anatomy questions. If you have any questions related to the human body or anatomy, feel free to ask."}];
							}}
						>
							<svg
								width="24"
						...
						<Card
							...
							on:click={() => {
								model = 'Microbiology';
                                messages=[{isUser:false,text:"Hi there! I'm an AI specialized in microbiology. I can help you with any questions or topics related to microbiology. If you have a non-microbiology question, I'll direct you to a relevant source to find the information you need."}]
						...
						<Card
							...
							on:click={() => {
								model = 'Pharmacology';
                                messages=[{isUser:false,text:"Hi there! I'm an AI specialized in pharmacology. I can help you with various aspects of drugs, such as their interactions, mechanisms, uses, side effects, and pharmacokinetics. If you have any questions related to pharmacology, feel free to ask."}]

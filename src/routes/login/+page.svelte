<script>
    ...
    const handleSignup = async () => {
        if (!termsAccepted) return; // Prevent sign-up if terms not accepted
    ...
    onMount(() => {
        ...
        termsCheckbox.addEventListener('change', function() {
            termsAccepted = termsCheckbox.checked; // Update termsAccepted based on checkbox state

            // Enable/disable sign-in button based on termsAccepted
            if (termsAccepted) {
